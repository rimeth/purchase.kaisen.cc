/**************************
 * Current source was made by meth (@13eth)
 * License: MIT

        ...            ...     ..      ..                     s                
    .uW8***88e.      x*8888x.:*8888: -"888:                  :8      .uef^"    
   d8*"     `"8N.   X   48888X `8888H  8888                 .88    :d88E       
 .@8F   .ucu.. %8L X8x.  8888X  8888X  !888>       .u      :888ooo `888E       
 @8E  .@8""988  8N X8888 X8888  88888   "*8%-   ud8888.  -*8888888  888E .z8k  
'88>  @8~  98F  98 '*888!X8888> X8888  xH8>   :888'8888.   8888     888E~?888L 
~88  X8E   98~  8E   `?8 `8888  X888X X888>   d888 '88%"   8888     888E  888E 
'88> 98&  d88  X8    -^  '888"  X888  8888>   8888.+"      8888     888E  888E 
 %8N '88W@"%8ed*`     dx '88~x. !88~  8888>   8888L       .8888Lu=  888E  888E 
  %8b. `"   ``      .8888Xf.888x:!    X888X.: '8888c. .+  ^%888*    888E  888E 
   `*8bu.. ..u@    :""888":~"888"     `888*"   "88888%      'Y"    m888N= 888> 
      ^"***%"`         "~'    "~        ""       "YP'               `Y"   888  
                                                                         J88"  
                                                                         @%    
                                                                       :"      
...
// Every single line of this code is explained to support devs, And to give them a chance to edit the code
// Weird layout ? Yea i wanted this code to be beautified as possible
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#MainCon', { style: 'fade-up', speed: 1000, intensity: 10, delay: 0, staggerOrder: '', replay: false });
    onvisible.add('#PayPalCon', { style: 'fade-down', speed: 1000, intensity: 10, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('#ComSubHead', { style: 'fade-left', speed: 750, intensity: 10, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('#SecSubHead', { style: 'fade-left', speed: 1250, intensity: 10, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('#SecButton', { style: 'fade-right', speed: 1250, intensity: 10, delay: 0, stagger: 125, replay: false });
    onvisible.add('#ComButton', { style: 'fade-right', speed: 1250, intensity: 10, delay: 0, stagger: 125, replay: false });
})();

/*
* Retarding Since 2020
* Meth from Retards Inc.
* Project Name: Pure JS Code
* License: MIT

____/\\\\\\\\\_______________________________________________________________________/\\\__________________________/\\\\\\\\\\\___________________________________        
 __/\\\///////\\\____________________________________________________________________\/\\\_________________________\/////\\\///____________________________________       
  _\/\\\_____\/\\\______________________/\\\__________________________________________\/\\\_____________________________\/\\\_______________________________________      
   _\/\\\\\\\\\\\/________/\\\\\\\\___/\\\\\\\\\\\__/\\\\\\\\\_____/\\/\\\\\\\_________\/\\\___/\\\\\\\\\\_______________\/\\\______/\\/\\\\\\_______/\\\\\\\\_______     
    _\/\\\//////\\\______/\\\/////\\\_\////\\\////__\////////\\\___\/\\\/////\\\___/\\\\\\\\\__\/\\\//////________________\/\\\_____\/\\\////\\\____/\\\//////________    
     _\/\\\____\//\\\____/\\\\\\\\\\\_____\/\\\________/\\\\\\\\\\__\/\\\___\///___/\\\////\\\__\/\\\\\\\\\\_______________\/\\\_____\/\\\__\//\\\__/\\\_______________   
      _\/\\\_____\//\\\__\//\\///////______\/\\\_/\\___/\\\/////\\\__\/\\\_________\/\\\__\/\\\__\////////\\\_______________\/\\\_____\/\\\___\/\\\_\//\\\______________  
       _\/\\\______\//\\\__\//\\\\\\\\\\____\//\\\\\___\//\\\\\\\\/\\_\/\\\_________\//\\\\\\\/\\__/\\\\\\\\\\____________/\\\\\\\\\\\_\/\\\___\/\\\__\///\\\\\\\\__/\\\_ 
        _\///________\///____\//////////______\/////_____\////////\//__\///___________\///////\//__\//////////____________\///////////__\///____\///_____\////////__\///__
